...
from acesflsecurity.resource_strategy import ResourceAwareFedAvg
...
def main(grid: Grid, context: Context):
    ...
    print("=" * 70)
    print("ACES-FL SECURITY: ATTACK WITHOUT DEFENSE")
    print("=" * 70)
    ...
    metrics_file = (
        results_dir
        / "aces_attack_no_defense_metrics.csv"
    )
    ...
    final_path = (
        results_dir
        / "aces_attack_no_defense_final_model.pt"
    )
    ...
    with open(
        results_dir / "aces_attack_no_defense_config.json",
        "w",
        encoding="utf-8",
    ) as file:
        json.dump(
