...
from acesflcompression.resource_strategy import ResourceAwareFedAvg

from acesflcompression.task import (
    Net,
    evaluate_model,
...
def main(grid: Grid, context: Context):
    ...
    print("=" * 70)
    print("ACES-FL ADAPTIVE SELECTION + COMPRESSION")
    print("=" * 70)
    ...
    final_path = (
        results_dir
        / "aces_compression_final_model.pt"
    )
    ...
    with open(
        ...
        results_dir / "aces_compression_config.json",
        "w",
        encoding="utf-8",
    ) as file:
        json.dump(
